...
export function InternalAccounts() {
  ...
  const handleSendInvitation = async (email: string) => {
    setIsInviting(email);
    try {
      const response = await fetch('/api/WAVInternalUser/send-invitation', {
        method: 'POST',
        headers: {
          'accept': '*/*',
      ...
      <div className="flex-none">
        ...
        <div className="flex items-center justify-between gap-4 bg-background p-3 rounded-lg shadow-sm border mb-4">
          ...
          <Button
            ...
            onClick={() => router.push("/internal/dashboard/createInternal")}
          >
                  ...
                  <td className="w-[9%] p-2 text-sm whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <Button
                        ...
                        size="icon"
                        className="h-7 w-7 hover:text-blue-600 hover:bg-blue-100/50 dark:hover:bg-blue-900/50"
                        onClick={() => router.push(`/internal/dashboard/edit-internal-profile/${user.id}`)}
                      >
                      ...
                      <Button
                        ...
                        size="icon"
                        className="h-7 w-7 hover:text-blue-600 hover:bg-blue-100/50 dark:hover:bg-blue-900/50"
                        onClick={() => router.push(`/internal/dashboard/internal-profile/${user.id}`)}
                      >

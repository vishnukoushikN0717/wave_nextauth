...
export default function OnboardingPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/WAVExternalUser/${userData.id}`, {
        method: 'PUT',
        headers: {
          'accept': '*/*',
      ...
      try {
        ...
        console.error('Failed to parse response:', e, 'Raw response:', responseText);
      ...
      setMessage({ text: "Profile updated successfully! Onboarding .....", type: 'success' });
